    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-primary border-b border-white/10">
      <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/loans" className="text-gray-300 hover:text-white text-sm font-medium transition-colors">Business Capital</Link>
          <a href="tel:+16029803338" className="text-gray-300 hover:text-white text-sm font-medium transition-colors">602.980.3338</a>
        </div>
        <a
